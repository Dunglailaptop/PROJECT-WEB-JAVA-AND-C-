 ...
 <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" />
  ...
  <body style="background-color:#1a1a1a;">
   ...
   <jsp:include page="header.jsp"></jsp:include>
    ...
    <a href="" style="color:red;">account lock</a><a href="mangeraccount.jsp"  style="color:red;">/mangeraccount</a>
                   ...
                   <c:forEach items="${user}" var="o">
                        ...
                        <img class="rounded-circle" src="${o.image}" alt="" style="width: 40px; height: 40px;">
                                ...
                                <input hidden name="number" value="2" type="text">
