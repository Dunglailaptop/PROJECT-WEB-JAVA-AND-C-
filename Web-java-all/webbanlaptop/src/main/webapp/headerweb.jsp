            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="phantrangproduct?num=1">Shop</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Cart.jsp">Contact</a>
                        </li>
                        <c:if test="${sessionScope.acc.idadmin==1 or sessionScope.acc.idadmin==3}">
                          <li class="nav-item">
                            <a class="nav-link" href="showadminuser?email=${user.email}&password=${user.password}">admin.jsp</a>
                        </li>
                        </c:if>
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <c:if test="${sessionScope.acc==null}">
                     <a class="nav-icon position-relative text-decoration-none" href="signin.jsp">
                    ...
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                           ...
                           <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="showuser?email=${sessionScope.acc.email}&pass=${sessionScope.acc.password}" class="dropdown-item">My Profile</a>
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <form action="search" method="get" class="modal-content modal-body border-0 p-0">
                <div class="input-group mb-2">
                    <input type="text" class="form-control" id="inputModalSearch" name="namesc"  placeholder="Search ...">
