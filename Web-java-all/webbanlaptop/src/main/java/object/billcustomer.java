...
public class billcustomer {
	...
	public billcustomer() {
	    ...
	    public billcustomer(String namecustomer, String email, String address, String pay,String sdt,String tinhtrang) {
	    ...
	    public billcustomer(String namecustomer, String email, String address, String pay, String tinhtrang, String sdt, String ngaydat, billproduct billp) {
	        this.namecustomer = namecustomer;
	        this.email = email;
	        this.address = address;
	        this.pay = pay;
