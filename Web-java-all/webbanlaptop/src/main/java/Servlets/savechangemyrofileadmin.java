...
@WebServlet("/savechangemyprofileadmin")
public class savechangemyrofileadmin extends HttpServlet {
 ...
 */
 public savechangemyrofileadmin() {
 super();
...
response.sendRedirect("signin.jsp");
		 ...
		 Logger.getLogger(savechangemyrofileadmin.class.getName()).log(Level.SEVERE, null, 
		ex);
		...
		ex);
		 ...
		 Logger.getLogger(savechangemyrofileadmin.class.getName()).log(Level.SEVERE, 
		null, ex);
		 }
		 }
}
