...
product listp=new product();
	 ...
	 try {
		 ...
		 image3="images/"+fileName4;
		 
		 Part part5= request.getPart("image4");
		 ...
		 image4="images/"+fileName5; 
		 
		 Part part6= request.getPart("image5");
		 ...
		 db.updatepictureProduct(image1, image2, image3, image4, image5, id); 
